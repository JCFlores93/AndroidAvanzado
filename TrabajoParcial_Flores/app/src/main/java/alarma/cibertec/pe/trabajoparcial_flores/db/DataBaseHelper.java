package alarma.cibertec.pe.trabajoparcial_flores.db;
...
public class DataBaseHelper extends SQLiteOpenHelper { public static final String DB_NAME="tasks.db";
    ...
    public static final String SQL_CREATE_TASKS =
            "CREATE TABLE "+ TaskContract.Task.TABLE_NAME + " (" +
                    ...
                    TaskContract.Task.COLUMN_NAME_REMEMBER + " INTEGER )";
